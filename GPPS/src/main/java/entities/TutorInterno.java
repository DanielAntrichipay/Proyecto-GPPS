...
public class TutorInterno extends Persona {
    private static final String LEGAJO_INVALIDO = "El legajo no puede estar en blanco o tener menos de 10 caracteres.";
    private String legajo;

    public TutorInterno(String nombreUsuario, String correo, String contrasenia, String nombre, String apellido, String dni, String legajo) {
